...
export default function App() {
  ...
  return (
    <div style={styles.page}>
      <Head>
        <title>SAVi — Assistant technicien</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover" />
        <meta name="theme-color" content="#020617" />
        <meta name="description" content="Diagnostic, documentation, relevé pour devis, heures et inventaire camion pour les techniciens de la fermeture industrielle." />
